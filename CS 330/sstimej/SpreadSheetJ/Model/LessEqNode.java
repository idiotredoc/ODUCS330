...
public
class LessEqNode extends BinaryExpression
{
  
  public LessEqNode (Expression leftOperand, Expression rightOperand)
  {
  ...
  {
    return new LessEqNode(left.clone(colOffset, rowOffset),
