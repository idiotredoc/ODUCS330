...
// Greater than (>)
public
class GreaterNode extends BinaryExpression
{
  
  public GreaterNode (Expression leftOperand, Expression rightOperand)
  {
  ...
  {
    return new GreaterNode(left.clone(colOffset, rowOffset),
