...
// Absolute value
public
class AbsNode extends UnaryExpression
{
  
  public AbsNode (Expression operand)
  {
    super(operand);
  }
  ...
  public Value evaluate(SpreadSheet s)
  {
    ...
    if (operandValue.valueKind() == NumericValue.valueKindName()) {
      ...
      result = new NumericValue(Math.abs(d));
    }
    else
  ...
  {
    return new AbsNode(opnd.clone(colOffset, rowOffset));
  }
  ...
  public String getOperator()    {return "abs";}
