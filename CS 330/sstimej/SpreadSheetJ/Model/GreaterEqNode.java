...
public
class GreaterEqNode extends BinaryExpression
{
  
  public GreaterEqNode (Expression leftOperand, Expression rightOperand)
  {
  ...
  {
    return new GreaterEqNode(left.clone(colOffset, rowOffset),
