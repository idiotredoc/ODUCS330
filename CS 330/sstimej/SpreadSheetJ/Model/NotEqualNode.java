...
// Not equal To (!=)
public
class NotEqualNode extends BinaryExpression
{
  
  public NotEqualNode (Expression leftOperand, Expression rightOperand)
  {
  ...
  {
    return new NotEqualNode(left.clone(colOffset, rowOffset),
