...
// Absolute value
public
class SqrtNode extends UnaryExpression
{
  
  public SqrtNode (Expression operand)
  {
    super(operand);
  }
  ...
  public Value evaluate(SpreadSheet s)
  {
    ...
    if (operandValue.valueKind() == NumericValue.valueKindName()) {
      ...
      result = new NumericValue(Math.sqrt(d));
    }
    else
  ...
  {
    return new SqrtNode(opnd.clone(colOffset, rowOffset));
  }
  ...
  public String getOperator()    {return "sqrt";}
